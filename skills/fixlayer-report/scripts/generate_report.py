...
# The classifier runs through a fixed argument list without invoking a shell.
...
def run_diagnose(trace_path: Path, challenges_dir: Path | None) -> dict:
    ...
    # The executable and every argument are constructed locally.
...
<footer>
  <p>
    Generated by <a href="https://cli-agent-spec.github.io/fixlayer.html">FixLayer</a> &nbsp;·&nbsp;
    built on the <a href="https://github.com/cli-agent-spec/cli-agent-spec">CLI Agent Spec</a>
    (74 failure modes · 158 requirements) &nbsp;·&nbsp;
