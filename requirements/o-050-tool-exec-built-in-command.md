...
{"ok":false,"data":null,"error":{"code":"VALIDATION_FAILED","message":"Invalid currency format","retryable":false,"phase":"validation"},"warnings":[],"meta":{"exit_code":2,"duration_ms":2,"_cmd":"commodity.create","_line":3}}
```
